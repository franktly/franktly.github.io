...
3.内存布局示意图：
![rhombus common derive](http://7xq8f9.com1.z0.glb.clouddn.com/pic%2Fobj_mod_1.PNG)


### 虚拟菱形继承类`Rhombus_Virtual`
---

#### 虚拟菱形继承类`Rhombus_Virtual`简单实现代码
...
#### 虚拟菱形继承类`Rhombus_Virtual`在`cl`命令的内存布局
...
#### 虚拟菱形继承类`Rhombus_Virtual`内存布局的代码验证
...
3.内存布局示意图：
![rhombus virtual derive](http://7xq8f9.com1.z0.glb.clouddn.com/pic%2Fobj_mod_1.PNG)
